        ...
        <div className='w-full   lg:h-[640px] bg-[#f7f4ef] mt-16 lg:grid lg:grid-cols-10'>
          ...
          <div className='col-span-6'>
            <img
              ...
              src='https://plus.unsplash.com/premium_photo-1729581091962-8da050639694?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
              alt=''
            />
          </div>
        </div>
